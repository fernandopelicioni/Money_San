...
MessageBox(0, 'Olá,'+#13+#10+'Por medidas de segurança, você pode apenas alterar a função e o Departamento dos colaboradores...', 'Fique atento!', MB_ICONWARNING or MB_OK);
...
if DtCadastro.DataSet.State = DsEDIT then
      BEGIN
            ...
            MessageBox(0, 'Aceitei sua alteração, pode continuar...', 'Tudo certo!',  MB_OK);
