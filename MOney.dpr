...
uses
  ...
  UnitAlteraDataBoletim in 'UnitAlteraDataBoletim.pas' {FormAlteraDataBoletim},
  UnitImportaColaborador in 'UnitImportaColaborador.pas' {FormImportaColaborador},
  UnitCadastraPro in 'UnitCadastraPro.pas' {FormCadastraPro},
  UnitLicanca in 'UnitLicanca.pas' {FormLicenca};
...
//  Application.Title := 'Center Bus - Revisão de Frotas';
  Application.Title := 'Money - Genoma Sofware';
