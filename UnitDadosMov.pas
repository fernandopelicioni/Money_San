...
if QrParamGlobal.FieldByName('ativacao').AsDateTime < EditData.Date then
     begin
            MessageBox(0, 'Seu sistema está com prazo de validade expirada, contate o administrador para renovação e atualização;'+#13+#10+''+#13+#10+'Fernando Pelicioni'+#13+#10+'Genoma Software'+#13+#10+'27 98115 0685', 'Necessário renovar a licença', MB_ICONSTOP or MB_OK);
            abort;
     end;
...
//              ShowMessage(Sql.Text);
              ...
              if Not Eof then
                    ...
                    Else
                    begin
                           ShowMessage('O caixa para este dia não está aberto, será necessário Abri-lo ou Reabri-lo !');
